					...
					<div className="control-menu">
						...
						{isLogin ? < div id="divUserStt">
							<div className="user-avatar">
								<a onClick={showControllInforUser} className="user-non-avatar text-avatar-type1 " href="#" rel="nofollow">
							...
							<div className="menuUser">
								<ul className="dropdown-user">
									<li style={{ paddingLeft: '0px !important', paddingBottom: '10px !important' }} className="lv0">
										<a onClick={showControllInforUser} className="user-name" >Tran Ngoc Hoang
											<img style={{ paddingLeft: '6px' }}
												src={arrow} width={16} /> </a>
										<ul className={`menu-user-child ${showControll}`}>
											<li className="subMenuUser">
												<div href="/trang-ca-nhan/uspg-lstproduct" className="haslink">
											...
											<li className="subMenuUser">
												<div href="/trang-ca-nhan/uspg-changeinfo" className="haslink">
													...
													<span>Thông tin cá nhân</span></div></li>
											<div className="border-menu" />
											<li className="subMenuUser" onClick={logOut}>
												<div className="logout haslink">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
