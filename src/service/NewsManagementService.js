...
const getAllPostOfUser = (pageNo, pageSize, sort, mode, fillterParam) => {
	const headers = headerCommon();
	console.log(fillterParam)
	return httpClient(headers, storageKey.API,
		`news-management/get-all-of-user?
			pageNo=${pageNo}&pageSize=${pageSize}&sort=${sort}&mode=${mode}
			&textSearch=${fillterParam.textSearch}&startedDate=${fillterParam.startedDate}
			&closedDate=${fillterParam.closedDate}
			&typeOfAcc=${fillterParam.typeOfAcc}&typeOfNews=${fillterParam.typeOfNews}
			&province=${fillterParam.province}&district=${fillterParam.district}`,
		'GET', {}).then((response) => {
			return response.data;
		})
}

const getWaittingApproved = (pageNo, pageSize, sort, mode, fillterParam) => {
	const headers = headerCommon();
	return httpClient(headers, storageKey.API,
...
const getNewsRejected = (pageNo, pageSize, sort, mode, fillterParam) => {
	const headers = headerCommon();
	return httpClient(headers, storageKey.API,
...
const getDontPayment = (pageNo, pageSize, sort, mode, fillterParam) => {
	const headers = headerCommon();
	return httpClient(headers, storageKey.API,
...
const getWaittingShowOfUser = (pageNo, pageSize, sort, mode, fillterParam) => {
	const headers = headerCommon();
	return httpClient(headers, storageKey.API,
...
const getNewsShowOfUser = (pageNo, pageSize, sort, mode, fillterParam) => {
	const headers = headerCommon();
	return httpClient(headers, storageKey.API,
...
const getNewsHiddenOfUser = (pageNo, pageSize, sort, mode, fillterParam) => {
	const headers = headerCommon();
	return httpClient(headers, storageKey.API,
...
const getNewsExpriedOfUser = (pageNo, pageSize, sort, mode, fillterParam) => {
	const headers = headerCommon();
	return httpClient(headers, storageKey.API,
